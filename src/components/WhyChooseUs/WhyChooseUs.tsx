          ...
          <div className="md:hidden space-y-10">
            {whyChooseData.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl border border-gray-200 dark:border-slate-700 px-6 pb-6 pt-12">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#1b3255] dark:bg-blue-600 flex items-center justify-center shadow-lg">
